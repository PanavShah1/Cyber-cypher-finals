...
const askData = () => {
    return fetch('http://127.0.0.1:8000/get-patients', {
        method: 'POST',
        headers: {
...
const clickChat = (emailDoc) => {
        ...
        let email2 = emailDoc;
        additionalString = 'doctor';
        let url = "chat_doctor.html?email1=" + encodeURIComponent(email2) + "&email2=" + encodeURIComponent(email1) + "&additional=" + encodeURIComponent(additionalString);
...
const createDoctor = (name, email, speciality) => {
    ...
    let htmlval = `<div class="doctor-label"><img src="../resources/images/faces/face${n}.png" alt=""><div class="info"><p>Name : ${name}</p><p>Contact : ${email}</p><div class="chat"><p>Chat</p> <img src="../resources/images/send.png" alt=""></div></div></div>`
